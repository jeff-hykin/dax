import type { FsFileWrapper, Path } from "https://esm.sh/jsr/@david/path@0.2";
import { Buffer } from "https://esm.sh/jsr/@std/io@0.221/buffer";
import { writeAll, writeAllSync } from "https://esm.sh/jsr/@std/io@0.221/write-all";
...
import type { Closer, Reader, ReaderSync, Writer, WriterSync } from "https://esm.sh/jsr/@std/io@0.221/types";
